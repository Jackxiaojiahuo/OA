...
<table style="min-width: 950px; width: 100%; height: 100%;" cellspacing="0" cellpadding="0" border="0">
  <tbody>
    <tr valign="top">
      <td id="colloaForm">
      <form action="../depart.do?action=addDepart" method="post">
          <table class="tableForm" summary="" style="table-layout:fixed;" cellspacing="0" cellpadding="0" border="0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                <input id="depart_name" name="depart_name" class="fieldEditable" value=""></td>
              </tr>
              <tr>
                <td>&nbsp;描述</td>
                <td><textarea name="depart_description" id="depart_description" class="fieldEditable" style="height: 200px;"></textarea></td>
              </tr>
            </tbody>
          </table>
        </form>
