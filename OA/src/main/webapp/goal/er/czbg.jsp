...
<script>
	$(function() {
		$('#btn').click(function() {
			...
			location.href = '../../repo.do?action=cz&names=' + s + '&count=' + c + '';
		});
	})
</script>
</head>
		...
		<tbody>
			<tr valign="top">
				...
				<td id="colloaForm"><table cellspacing="0" cellpadding="0"
						...
						<tbody>
							<tr>
								<td><span class="textBig">查找工作报告</span> <input checked=""
									name="field" value="report_create_name" type="radio">按创建人
									<input name="field" value="report_name" type="radio">按报告名称
