...
<script>
	$(function() {
		$('#btn').click(function() {
			...
			var name=$("#person").val();
			location.href = '../../pros.do?action=cz&name='+name+'&names=' + s + '&count=' + c + '';
		});
	})
</script>
</head>
		...
		<tbody>
			<tr valign="top">
				<td id="colloaForm"><table cellspacing="0" cellpadding="0"
						...
						<tbody>
							<tr>
								<td><span class="textBig">查找工作计划</span> <input 
									id="person" value="${s_emp.emp_name }" type="hidden">
									<input checked="" name="field" value="prospectus_name" type="radio">按计划名称
