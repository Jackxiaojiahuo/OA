...
$(document).ready(function() {
	...
	//json字符串,从数据库读取数据,利用ajax
	var jsonStr=[{title:'项目会议',start:new Date(y,m,22)},{title:'行政部会议',start:new Date(y,m+1,1)},{title:'后勤部部会议',start:new Date(y,m+1,2,11,0),end:new Date(y,m+1,2,12,0),allDay:false}];
	//原字符串
	var json=[
			{
				title: 'All Day Event3',
				start: new Date(y, m-1, d+19)
			},
			{
				title: 'All Day Event',
			...
			},
			{
				...
				start: new Date(y, m, d-3, 16, 0),//参数1:年份.2:月份.3:日期.4:小时(24小时制).5分钟
				allDay: false
			},
			{
				id: 999,
