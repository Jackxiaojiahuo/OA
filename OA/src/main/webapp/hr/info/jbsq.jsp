...
<link type="text/css" rel="stylesheet" href="jquery-ui.css"  /> 
 ...
 function checkapplydate(){
	  var applydate=$("input[name='oi_applydate']").val();
...
function checkcdate(){
	  var cdate=$("input[name='oi_cdate']").val();
	  var cdateid=$("#cdateid");
		if(cdate==""){
			cdateid.show();
			return false;
...
function checkddate(){
	  var ddate=$("input[name='oi_ddate']").val();
	  var ddateid=$("#ddateid");
		if(ddate==""){
			ddateid.show();
			return false;
            ...
            <table class="tableForm" style="table-layout: fixed;" cellspacing="0" cellpadding="0" align="center" border="0">
              ...
              <tbody>
                <tr>
                  ...
                  <td id="dbf.subject" dbf.type="required" colspan="5"><input id="e.dbf.subject" class="fieldEditable" name="oi_theme" value="加班申请-${s_emp.emp_name }"><input type="hidden" name="emp_id" value="${s_emp.emp_id }"></td>
                </tr>
                <tr>
                  ...
                  <td id="dbf.endTime" dbf.type="date" dbf.source="date,editable"><!--<img class="fieldGetValueBySource" src="../css/fieldSource.gif">-->
                    <div class="fieldEditable" contenteditable="true"><input type="text" id="selectDate" name="oi_shopdate" placeholder="请输入结束时间"></div></td>
                </tr>
              </tbody>
            </table>
                ...
                <tbody>
                  ...
                  <td id="dbf.operatorSource" dbf.type="required" dbf.source="" dbf.key="">
                    ...
                    <td id="dbf.time2" dbf.type="date,required" dbf.source="date"><!--<img class="fieldGetValueBySource" src="../css/fieldSource.gif">-->
                      <div><input type="text" id="sqDate" name="oi_applydate" onblur="checkapplydate()" placeholder="请输入申请时间" /><span id="applydateid" style="color:red; display: none;">不能为空</span></div></td>
                  </tr>
                  <tr>
                    ...
                    <td id="dbf.time0" dbf.type="date,required" dbf.source="datetime,editable"><!--<img class="fieldGetValueBySource" src="../css/fieldSource.gif">-->
                      <div class="fieldEditable" contenteditable="true"><input type="text" id="kDate" name="oi_cdate" onblur="checkcdate()" placeholder="请输入加班时间" /><span id="cdateid" style="color:red; display: none;">不能为空</span></div></td>
                    ...
                    <td id="dbf.time1" dbf.type="date,required" dbf.source="datetime,editable"><!--<img class="fieldGetValueBySource" src="../css/fieldSource.gif">-->
                      <div class="fieldEditable" contenteditable="true"><input type="text" id="sDate" name="oi_ddate" onblur="checkddate()" placeholder="请输入加班时间" /><span id="ddateid" style="color:red; display: none;">不能为空</span></div></td>
