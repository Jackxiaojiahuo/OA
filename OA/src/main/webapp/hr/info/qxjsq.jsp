          ...
          <form class="formTaskflow" action="../../work.do?action=kqsq" method="post">
            <table class="tableForm" style="table-layout: fixed;" cellspacing="0" cellpadding="0" align="center" border="0">
              ...
              <tbody>
                <tr>
                  ...
                  <td id="dbf.subject" dbf.type="required"><input id="e.dbf.subject" class="fieldEditable" name="fg_theme"></td>
                  <td style="text-align: right;">&nbsp;优先级:</td>
                  <td><input id="dbf.priority" value="低" name="fg_priority" autocomplete="off" type="radio">
                    低
                    <input id="dbf.priority" checked="" value="中" name="fg_priority" autocomplete="off" type="radio">
                    中
                    <input id="dbf.priority" value="高" name="fg_priority" autocomplete="off" type="radio">
                    高</td>
                </tr>
                <tr>
                  ...
                  <td id="dbf.endTime" dbf.type="date" dbf.source="date,editable"><!--<img class="fieldGetValueBySource" src="../css/fieldSource.gif">-->
                    <div class="fieldEditable" contenteditable="true"><input type="text" id="selectDate" name="fg_shopdate"></div></td>
                </tr>
              </tbody>
            </table>
              ...
              <table class="tableListBorder" cellspacing="0" cellpadding="0" align="center" border="0">
                ...
                <tbody>
                  ...
                  <td style="text-align: center;"><span style="color: rgb(255, 0, 0);">*</span>申请人</td>
                    <td id="dbf.operatorSource" dbf.type="required" dbf.source="" dbf.key=""><input id="e.dbf.operatorSource" class="fieldEditable" value="${q.em.emp_name } "name="emp_id"><input type="hidden" name="emp_id" value="${q.em.emp_id }"><span id="nameid" style="color:red; display: none;" >不能为空</span></td>
            ...
            <td class="select_box"><select name="depart_id">
                    ...
                    <td id="dbf.time2" dbf.type="date,required" dbf.source="date"><!--<img class="fieldGetValueBySource" src="../css/fieldSource.gif">-->
                      <div><input type="text" id="sqDate" name="fg_applydate"></div></td>
                  </tr>
                  <tr>
                    ...
                    <td id="dbf.time0" dbf.type="date,required" dbf.source="datetime,editable"><!--<img class="fieldGetValueBySource" src="../css/fieldSource.gif">-->
                      <div class="fieldEditable" contenteditable="true"><input type="text" id="kDate" name="fg_cdate"></div></td>
...
-->                      <div class="fieldEditable" contenteditable="true"><input type="text" id="jDate" name="fg_ddate"></div></td>
