...
function sub(num){
	...
	if(num==1){
		location.href='../../work.do?action=kqcz&op=qxj&names='+s+'&count='+c+'&index=1';
	}else if(num==2){
		location.href='../../work.do?action=kqcz&op=qxj&names='+s+'&count='+c+'&index=${page.index-1 eq 0 ? 1 : page.index-1}';
	}else if(num==3){
		location.href='../../work.do?action=kqcz&op=qxj&names='+s+'&count='+c+'&index=${page.index+1 gt page.total ? page.total : page.index+1}';
	}else if(num==4){
		location.href='../../work.do?action=kqcz&op=qxj&names='+s+'&count='+c+'&index=${page.total}';
	}
}
</script>
</head>
