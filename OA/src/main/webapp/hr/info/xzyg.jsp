	...
	<body id="colloaBody">
		<table style="min-width: 950px; width: 100%; height: 100%;" cellspacing="0" cellpadding="0" border="0">
			<tbody>
				<tr valign="top">
					<td id="colloaForm">
						<form name="form1" action="../../emp.do?action=add" method="post">
							<table class="tableForm">
								<tbody>
									...
									<tr>
										...
										<td><input type="text" name="emp_name" placeholder="请输入姓名" onblur="checkna()" required/><span class="tips" id="divname"></span></td>
										<td class="fieldLable">工号</td>
										<td><input type="text" id="code" name="emp_code" placeholder="请输入工号"><span id="codeid" style="color:red; display: none;"></span></td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><input type="text" name="emp_mobile" placeholder="请输入你的移动电话" onblur="checkMobile()" required/><span class="tips" id="mobileid"></span></td>
										<td class="fieldLable">固定电话</td>
										<td><input type="text" name="emp_phone" placeholder="请输入你的固定电话" onblur="checkPhone()" required/><span class="tips" id="phoneid"></span></td>
									</tr>
									<tr>
										<td class="fieldLable">电子邮件</td>
										<td><input type="text" name="emp_email" placeholder="请输入你的邮箱" onblur="checkmail()" required/><span class="tips" id="emailid"></span></td>
										<td class="fieldLable">即时通信(QQ)</td>
										<td><input type="text" name="emp_qq" placeholder="请输入你的QQ" onblur="checkQQ()" required/><span class="tips" id="qqid"></span></td>
									</tr>
									<tr>
										<td class="fieldLable">出生日期</td>
										<td>
											<input type="text" id="csDate" name="emp_birth" onblur="checkbirth()" placeholder="请输入出生日期" required/>
										</td>
										<td class="fieldLable">入职日期</td>
										<td>
											<input type="text" id="rzDate" name="emp_join" onblur="checkjoin()" placeholder="请输入入职日期" required/>
										</td>
									</tr>
									<tr>
										<td class="fieldLable">转正日期</td>
										<td>
											<input type="text" id="zzDate" name="emp_formal" placeholder="请输入转正日期" />
										</td>
										<td class="fieldLable">离职日期</td>
										<td>
											<input type="text" id="lzDate" name="emp_leave" placeholder="请输入离职日期" />
										</td>
									</tr>
									<tr>
										<td class="fieldLable">附加描述</td>
										<td id="dbf.description" colspan="3"><input type="text" name="emp_description"/></td>
									</tr>
								</tbody>
							</table>
