...
<link rel="stylesheet" href="../css/xgyg.min.css">
<link rel="stylesheet" href="../css/xgyg.css">
...
<table style="min-width: 950px; width: 100%; height: 100%;" cellspacing="0" cellpadding="0" border="0">
  <tbody>
    <tr valign="top">
      <td id="colloaForm"><form action="../../emp.do?action=update" method="post">
          <table class="tableForm" style="table-layout: fixed;" summary="" cellspacing="0" cellpadding="0" border="0" align="center">
            <colgroup>
            <col width="100">
            <col>
            <col width="100">
            ...
            <tbody>
              <tr>
                ...
                <td id="dbf.psid" dbf.key="1000011" dbf.source="select sid,name,psid,stype from userX where statusX=1 and stype=10000 order by sortId,name">
                ...
                <td id="dbf.jobDesc" colspan="3"><input id="e.dbf.jobSid" class="fieldEditable" value="${e.emp_description }" name="emp_description"></td>
              </tr>
              <tr>
             ...
             <tr>
                ...
                <td><input id="dbf.gender" checked="checked" value="男" name="emp_sex" type="radio">
                  男
                  <input id="dbf.gender" value="女" name="emp_sex" type="radio">
                  女</td>
                <td class="fieldLable">在职状态</td>
                <td><input id="dbf.jobStatus" checked="checked" value="在职" name="emp_state" type="radio">
                  在职
                  <input id="dbf.jobStatus"  value="试用" name="emp_state" type="radio">
                  试用
                  <input id="dbf.jobStatus"  value="退休" name="emp_state" type="radio">
                  退休
                  <input id="dbf.jobStatus" value="离职" name="emp_state"  type="radio">
                  离职</td>
              </tr>
              <tr>
