...
<link rel="stylesheet" href="css/yclsw.css">
			...
			<tr valign="top">
				<td id="colloaContent"><table border="0" cellpadding="0"
						...
						<tbody>
							<tr>
								<td><h1>
										<img style="cursor: pointer;" src="css/menu.png"> 已处理的事务
									</h1></td>
								<td align="right"><script language="javaScript">
									/* Code removed by ScrapBook */
								</script><span
									id="oWorkflowList1"><a href="work/ycldsw_cz.html"
										class="button1 button1L">查找</a></span><a class="button1 button1R"
									title="刷新">&nbsp;<i class="fa fa-bolt fa-lg"></i></a>
											...
											<tr>
												<td style="padding: 10px;"><div id="treeOfNavigation"
														...
														<a psid="0" sid="130000" class='yclsw1'
															...
															sid="703220" class='yclsw3' indent="2" href="../work.do?action=Wklist&num=1"
															style="padding-left: 24px; display: none;"><img
															src="css/blank16.gif" border="0"><img
								...
								<td><table class="tableList" border="0" cellpadding="0"
										...
										<tbody>
											...
											<tr>
												...
												<td>2017/1/5 13:26&nbsp;</td>
											</tr>
											<tr>
												<td><a><i style="color: rgb(60, 188, 60);"
														class="fa fa-calendar-check-o fa-lg"></i><img
														src="css/priority0.gif" border="0">蓝牙音频SoC芯片 </a></td>
												<td>[<b>通过转项目实施</b>] &nbsp;
												</td>
												<td>2017/1/5 13:26&nbsp;</td>
											</tr>
											<tr>
												<td><a><i style="color: rgb(60, 188, 60);"
														class="fa fa-calendar-check-o fa-lg"></i><img
														src="css/priority0.gif" border="0">产品定位和制定项目计划</a></td>
												<td>[<b>关闭任务</b>] &nbsp;
												</td>
												<td>2017/1/5 13:26&nbsp;</td>
											</tr>
											<tr>
												...
												<td>2017/1/5 13:25&nbsp;</td>
											</tr>
											<tr>
												<td><a><i style="color: rgb(60, 188, 60);"
														class="fa fa-calendar-check-o fa-lg"></i><img
														src="css/priority0.gif" border="0">关键技术指标</a></td>
												<td>[<b>直接关闭任务</b>] &nbsp;
												</td>
												<td>2017/1/5 13:25&nbsp;</td>
											</tr>
											<tr>
												<td><a><i style="color: rgb(60, 188, 60);"
														class="fa fa-calendar-check-o fa-lg"></i><img
														src="css/priority0.gif" border="0">Factsheet</a></td>
												<td>[<b>直接关闭任务</b>] &nbsp;
												</td>
												<td>2017/1/5 13:25&nbsp;</td>
											</tr>
											<tr>
												...
												<td>2017/1/5 13:24&nbsp;</td>
											</tr>
											<tr>
												<td><a><i style="color: rgb(60, 188, 60);"
														class="fa fa-calendar-check-o fa-lg"></i><img
														src="css/priority0.gif" border="0">生产工艺选项报告</a></td>
												<td>[<b>直接关闭任务</b>] &nbsp;
												</td>
												<td>2017/1/5 13:24&nbsp;</td>
											</tr>
											<tr>
												<td><a><i style="color: rgb(60, 188, 60);"
														class="fa fa-calendar-check-o fa-lg"></i><img
														src="css/priority0.gif" border="0">风险评估报告</a></td>
												<td>[<b>直接关闭任务</b>] &nbsp;
												</td>
												<td>2017/1/5 13:24&nbsp;</td>
											</tr>
											<tr>
												<td><a><i style="color: rgb(60, 188, 60);"
														class="fa fa-calendar-check-o fa-lg"></i><img
														src="css/priority0.gif" border="0">预研阶段ESD问题评估</a></td>
												<td>[<b>直接关闭任务</b>] &nbsp;
												</td>
												<td>2017/1/5 13:24&nbsp;</td>
											</tr>
											<tr>
												<td><a><i style="color: rgb(60, 188, 60);"
														class="fa fa-calendar-check-o fa-lg"></i><img
														src="css/priority0.gif" border="0">立项评审表</a></td>
												<td>[<b>直接关闭任务</b>] &nbsp;
												</td>
												<td>2017/1/5 13:23&nbsp;</td>
											</tr>
											<tr>
												<td><a><i style="color: rgb(60, 188, 60);"
														class="fa fa-calendar-check-o fa-lg"></i><img
														src="css/priority0.gif" border="0">系列产品问题检查表</a></td>
												<td>[<b>直接关闭任务</b>] &nbsp;
												</td>
												<td>2017/1/5 13:23&nbsp;</td>
											</tr>
											<tr>
												<td><a><i style="color: rgb(60, 188, 60);"
														class="fa fa-calendar-check-o fa-lg"></i><img
														src="css/priority0.gif" border="0">Schedule</a></td>
												<td>[<b>关闭任务</b>] &nbsp;
												</td>
												<td>2017/1/5 13:23&nbsp;</td>
											</tr>
											<tr>
												<td><a><i style="color: rgb(60, 188, 60);"
														class="fa fa-calendar-check-o fa-lg"></i><img
														src="css/priority0.gif" border="0">奖金计划</a></td>
												<td>[<b>关闭任务</b>] &nbsp;
												</td>
											...
											<tr>
												<td><a><i style="color: rgb(60, 188, 60);"
														class="fa fa-calendar-check-o fa-lg"></i><img
														src="css/priority0.gif" border="0">立项会议</a></td>
												<td>[<b>关闭任务</b>] &nbsp;
												</td>
												<td>2017/1/5 13:22&nbsp;</td>
											</tr>
											<tr>
												<td><a><i style="color: rgb(60, 188, 60);"
														class="fa fa-calendar-check-o fa-lg"></i><img
														src="css/priority0.gif" border="0">数字设计及验证</a></td>
												<td>[<b>关闭任务</b>] &nbsp;
												</td>
												<td>2017/1/5 13:22&nbsp;</td>
											</tr>
									...
									<div style="padding: 20px 0px;">
										<a class="button1 button1L" title="首页"><i
											...
											class="button1M">共有 1175 条记录，第 1/59 页</span><a
